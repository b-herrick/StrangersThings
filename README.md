...
- [Yup] A user should see some content on the about us page.
- [Yup] A user should be able to navigate to a contact us page.
- [] The login/register button should be disabled if a username or password is not provided.
- [Yup] A user should see the author of the post next to the post listing.
- [Yup] The description for the posts should be visible on the post detail page.
